    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="w-full px-2 sm:px-4 py-2 sm:py-4">
        <div className="max-w-sm sm:max-w-2xl xl:max-w-6xl mx-auto">
          <div className="text-center mb-3 sm:mb-6 xl:mb-8">
            <h1 className="text-xl sm:text-3xl xl:text-4xl font-bold text-slate-800 mb-1 sm:mb-2">
              Wordle Solver
            </h1>
          ...
          <div className="grid gap-2 sm:gap-4 xl:gap-6 xl:grid-cols-2">
            <div className="space-y-2 sm:space-y-4 xl:space-y-6">
              <Card className="p-1 sm:p-4 xl:p-6 shadow-lg border-0 bg-white/70 backdrop-blur-sm">
                <WordLengthSelector 
            ...
            <div>
              <Card className="p-1 sm:p-4 xl:p-6 shadow-lg border-0 bg-white/70 backdrop-blur-sm h-fit">
