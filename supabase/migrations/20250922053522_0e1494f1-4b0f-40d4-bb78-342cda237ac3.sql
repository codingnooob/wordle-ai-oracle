-- Fix Column Ambiguity in get_job_status_secure_v2 Function
-- Update the function to properly qualify the created_at column reference
...
BEGIN
  ...
  -- Validate job exists and session token matches (FIX: properly qualify created_at)
  IF NOT EXISTS (
