-- Phase 1: Fix Database Function to Return Complete Job Status with Results
-- Update get_job_status_secure_v2 to return all required fields including analysis results
